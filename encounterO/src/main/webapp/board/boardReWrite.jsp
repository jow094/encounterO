		...
		<div class = "box_total">
			...
			<!-- box_left -->
					...
					<div class="bodytext_area box_center">
							<form action="./BoardReWriteAction.bo?directory=${param.directory}&bno=${param.bno}&pageNum=${param.pageNum}&pageSize=${param.pageSize}&contentNum=${param.contentNum}&count=${param.count}&criteria=${param.criteria}&keyWord=${param.keyWord}" method="post" class="upload">
