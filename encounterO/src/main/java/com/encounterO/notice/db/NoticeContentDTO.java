...
public class NoticeContentDTO extends NoticeDTO{
	...
	public String toString() {
		return "NoticeContentDTO [bno=" + bno + ", id=" + id + ", name=" + name + ", pass=" + pass + ", subject="
				+ subject + ", content=" + content + ", readcount=" + readcount + ", re_ref=" + re_ref + ", re_lev="
				+ re_lev + ", re_seq=" + re_seq + ", date=" + date + ", ip=" + ip + ", file=" + file + ", prevBno="
				+ prevBno + ", nextBno=" + nextBno + ", prevSub=" + prevSub + ", nextSub=" + nextSub + "]";
	}
